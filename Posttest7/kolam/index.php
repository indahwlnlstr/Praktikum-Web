...
<body class="body">
    ...
    <form action="" method="GET">
      <input type="text" name="keyword" placeholder="Cari Kolam">
            ...
            <tr>
                ...
                <?php
                    ...
                    if(isset($_GET['cari'])){
                        ...
                        $result = mysqli_query($connect, "SELECT * FROM kolam INNER JOIN images ON kolam.id_kolam = images.id_kolam WHERE nama_kolam LIKE '%$keyword%'");
                      } else{
                        $result = mysqli_query($connect, "SELECT * FROM kolam INNER JOIN images ON kolam.id_kolam = images.id_kolam");
                      }
                      
                        $kolam = [];
                        while($rowKolam = mysqli_fetch_assoc($result)){
                          $kolam    [] = $rowKolam;
                ?>
